    ...
    <div className="hero-symbol-container">
      ...
      <div
        ...
        style={{
          transform: `
            translate(
              calc(50vw - 50% - ${separation}vw + ${mouseX}px),
              calc(50vh - 50% + ${separation * 2}vh + ${mouseY}px)
            )
            scale(${scale})
      ...
      <div
        ...
        style={{
          transform: `
            translate(
              calc(50vw - 50% + ${separation}vw + ${mouseX * 0.8}px),
              calc(50vh - 50% + ${separation * 2}vh + ${mouseY * 0.8}px)
            )
            scale(${scale})
            rotate(${rotation + spin}deg)
          `,
